        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto" activeKey={pageInfo && pageInfo.pageName}>
            ...
            <Link to="/alaschem">
              ...
              <button type="button" class="btn btn-dark">ALASCHEM</button>
              </Nav.Link>
            </Link>
            <Link to="/faculty">
              <Nav.Link as="span" eventKey="Faculty">
              <button type="button" class="btn btn-dark">Faculty</button>
              </Nav.Link>
            </Link>
            <Link to="/statistics">
              <Nav.Link as="span" eventKey="Statistics">
              <button type="button" class="btn btn-dark">Statistics</button>
              </Nav.Link>
            </Link>
            <Link to="/syllabus">
              <Nav.Link as="span" eventKey="Syllabus">
              <button type="button" class="btn btn-dark">Syllabus</button>
              </Nav.Link>
            </Link>
            <Link to="/NAAC">
              <Nav.Link as="span" eventKey="NAAC">
              <button type="button" class="btn btn-dark">NAAC</button>
              </Nav.Link>
            </Link>
            <Link to="/reading-material">
              <Nav.Link as="span" eventKey="ReadingMaterial">
              <button type="button" class="btn btn-dark">Reading Material</button>
              </Nav.Link>
            </Link>
            <Link to="/photo-gallery">
              <Nav.Link as="span" eventKey="PhotoGallery">
              <button type="button" class="btn btn-dark">Photo Gallery</button>
              </Nav.Link>
            </Link>
            <Link to="/notice">
              <Nav.Link as="span" eventKey="Notice">
              <button type="button" class="btn btn-dark">Notice</button>
              </Nav.Link>
            </Link>
